...
import { T as TwoslashError, t as typesToExtension, d as defaultCompilerOptions, c as defaultHandbookOptions, a as findFlagNotations, f as findCutNotations, b as findQueryMarkers, s as splitFiles, e as removeTsExtension, h as getExtension, g as getObjectHash, i as getIdentifierTextSpans } from './shared/twoslash.081d64c9.mjs';
export { r as removeTwoslashNotations } from './shared/twoslash.081d64c9.mjs';
...
function createTwoslasher(createOptions = {}) {
  ...
  const system = useFS ? createSystem(vfs) : {
